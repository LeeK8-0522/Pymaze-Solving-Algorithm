...
class Cell(object):
    ...
    def remove_walls(self, neighbour_row, neighbour_col): # 이웃 셀과 자신 사이에 wall 제거하기
    ...
    def set_as_entry_exit(self, entry_exit, row_limit, col_limit): # 해당 셀의 위치를 토대로 wall을 제거하여 미로의 입구나 출구로 설정
